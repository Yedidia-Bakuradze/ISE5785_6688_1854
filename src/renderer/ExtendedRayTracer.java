...
public class ExtendedRayTracer extends RayTracerBase {
     ...
     */
    public ExtendedRayTracer(Scene scene, TargetAreaBase targetArea) {
        super(scene);
     ...
     */
    private List<Ray> calcRefractionRays(Intersectable.Intersection intersection) {
     ...
     */
    private Vector calcReflection(Intersectable.Intersection intersection, Vector direction) {
